...
import user from "../../../../public/user/emonji.png"
        ...
        <div className='grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-5'>
            <div className="transition-all duration-200  bg-white border border-gray-200 shadow-xs break-inside-avoid-column rounded-xl hover:shadow-md hover:-translate-y-1">
                <div className="px-4 py-5 space-y-6 sm:p-6">
                    ...
                    <button type="button" className="flex items-center justify-center w-full gap-2 p-2 text-sm font-medium leading-6 text-gray-500 transition-all duration-150 rounded-full group bg-gray-50 hover:text-gray-700 hover:ring-gray-200 ring-1 ring-transparent">Edit &amp; Post</button>
                </div>
            </div>
            <div className="transition-all duration-200  bg-white border border-gray-200 shadow-xs break-inside-avoid-column rounded-xl hover:shadow-md hover:-translate-y-1">
                <div className="px-4 py-5 space-y-6 sm:p-6">
