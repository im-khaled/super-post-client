...
const DashAside = () => {
    return (
        <aside className="mt-24 border-r-2 ms-5 w-1/5 whitespace-nowrap" >
                ...
                <ul className="space-y-8 overflow-y-scroll h-96 py-5 font-medium ps-2  text-gray-600">
                    <li><Link href='/app/ai'><span className="inline-block me-2 font-semibold"><AiOutlinePicLeft /></span>Post Generator</Link></li>
                    <li><Link href=''><span className="inline-block me-2 font-semibold"><AiOutlineAlert /></span>Ideas Generator</Link></li>
                    <li><Link href=''><span className="inline-block me-2 font-semibold"><AiOutlineBorder /></span>Carousel Maker</Link></li>
                    <li><Link href=''><span className="inline-block me-2 font-semibold"><MdOutlinePostAdd /></span>Post</Link></li>
                    <li><Link href=''><span className="inline-block me-2 font-semibold"><AiOutlineLineChart /></span>Content Inspiration</Link></li>
